...
- List availble CloudWatch metrics for a RDS resource
- Access the latest performance data for a RDS resource
- See AWS generated recommendations for your RDS usage
- See recent events for your RDS resources
