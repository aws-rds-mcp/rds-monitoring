...
"""Boto3 clients configurations for the RDS Monitoring MCP Server."""
...
def get_cloudwatch_client(
    ...
    """Get an Amazon CloudWatch client.
    ...
    Returns:
        A CloudWatch client instance
    """
    if profile_name:
        client = boto3.Session(profile_name=profile_name).client(
            'cloudwatch', region_name=region_name or 'us-east-1'
        )
        return client  # type: ignore
    client = boto3.client('cloudwatch', region_name=region_name or 'us-east-1')
    return client  # type: ignore
